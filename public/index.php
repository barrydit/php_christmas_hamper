...
defined('APP_BASE_PATH') // $_SERVER['DOCUMENT_ROOT']
  or define('APP_BASE_PATH', dirname(__DIR__, 1));

defined('COMPOSER_AUTOLOAD_PATH')
  or define("COMPOSER_AUTOLOAD_PATH", APP_BASE_PATH . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR); // basename(dirname(__FILE__)) . DIRECTORY_SEPARATOR . '..' .
...
$includeFiles = [
  APP_BASE_PATH . '/config/config.php',
